...
namespace BookShop.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportBooks(BookShopContext context, string xmlString)
        {
            ...
            {
                ImportBooksDto[] booksDto = (ImportBooksDto[])xmlSerializer.Deserialize(stringReader);

                List<Book> validBooks = new List<Book>();

                foreach (ImportBooksDto bookDto in booksDto)
                {
                    if (!IsValid(bookDto))
                    {
                    ...
                    bool isDateValid = DateTime.TryParseExact(bookDto.PublishedOn,
        ...
        public static string ImportAuthors(BookShopContext context, string jsonString)
        {
            ...
            foreach (ImportAuthorDto authorDto in authorsDtos)
            {
